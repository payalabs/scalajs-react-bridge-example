...
import japgolly.scalajs.react.{Callback, CallbackTo, Key}
...
object TagsInput extends ReactBridgeComponent {
  def apply(id: js.UndefOr[String]  = js.undefined, className: js.UndefOr[String] = js.undefined,
            ...
            transform: js.UndefOr[String => CallbackTo[String]] = js.undefined): ComponentNoChild = this.autoConstructNoChild
}
